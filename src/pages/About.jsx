...
const About = () => (
  <div className="container mx-auto px-6 py-16" id="about">
    ...
    <p className="text-gray-700 leading-relaxed mb-4">
      I’m a motivated and detail-oriented Software Engineer who thrives on 
      building responsive and scalable applications. I’ve designed and shipped 
      multiple full-stack projects using React, Spring Boot, Kafka, and 
      RESTful APIs, and continuously explore cloud-native and DevOps best 
